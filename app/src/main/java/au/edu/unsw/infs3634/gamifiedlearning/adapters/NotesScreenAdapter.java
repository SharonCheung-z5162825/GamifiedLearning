...
public class NotesScreenAdapter extends RecyclerView.Adapter<NotesScreenAdapter.MyViewHolder> {
    private static final String TAG = "NotesScreenAdapter";
    ...
    ArrayList<UserNote> myArray;
    RecyclerViewClickListener listener;

    //Make the constructor as needed (same as with any other class)
    public NotesScreenAdapter(ArrayList<UserNote> myArray, RecyclerViewClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.note_row_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        holder.tvNoteTitle.setText(myArray.get(position).getTitle());
        holder.tvNoteContent.setText(myArray.get(position).getContent());
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyViewHolder( View itemView, RecyclerViewClickListener listener) {
            ...
            //initialise views
            this.listener = listener;
            this.tvNoteTitle = itemView.findViewById(R.id.tvLearnModuleTitle);
            this.tvNoteContent = itemView.findViewById(R.id.tvNoteContent);
        }

        //When testing this code, look for when this log message shows up
        @Override
        public void onClick(View v) {
            Log.d(TAG, "onClick: inside NotesScreenAdapter on click");
